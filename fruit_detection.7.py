...
import os
import pygame
import apriltag  # AprilTag detection library
...
# Mapping variables
MAP_SIZE = 1000  # Revert the map size to its original size in pixels
...
def main():
    """Main function to run the fruit and obstacle detection system."""
    global last_obstacle_distance
            ...
            if frame_count % 5 == 0:
                ...
                for detection in detections:
                    for obj in detection:
                        ...
                        if confidence > 0.6 and classes[class_id] in FRUITS:  # Increased confidence threshold
